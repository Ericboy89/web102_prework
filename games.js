...
// Calculate total number of backers
const totalBackers = games.reduce((acc, game) => acc + game.backers, 0);
...
// If you need to display the stats, you can use this:

// Example code to show statistics (ensure these elements exist in your HTML)
const contributionsCard = document.getElementById('num-contributions');
const raisedCard = document.getElementById('total-raised');
const gamesCard = document.getElementById('num-games');

contributionsCard.textContent = `Total Contributions: ${totalBackers.toLocaleString('en-US')}`;
raisedCard.textContent = `Total Raised: $${totalRaised.toLocaleString('en-US')}`;
...
// // Display the total number of backers in the contributionsCard
